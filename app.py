...
cors = CORS(app, supports_credentials=True , resources={r'/*' : {'origins': ['chrome-extension://hjkiogfeljgpfefeihhlakafgnjkobgj','https://www.cloudclipboard.app', 'https://cloudclipboard.app', 'moz-extension://*']}})
